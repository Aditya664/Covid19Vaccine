 ...
 * @author Aditya
 */
public class CenterSupply extends javax.swing.JFrame {
    ...
    public CenterSupply() {
        initComponents();
        db.fillTable(jTable1, "select * from centertbl");
        db.fillCombo(center, "select name from centertbl");
    }
    ...
    private void initComponents() {
        ...
        center.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        kGradientPanel1.add(center, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 178, -1));
            ...
            try {
                if (rs.next()) {
                    ...
                    if (st > cv) {
                        ...
                        ResultSet rs2 = db.getData("select * from centertbl where name = '" + dist + "'");
                        if (rs2.next()) {
                            int rem = cv - st;
                            int oldst = rs2.getInt(9);
                            int newst = oldst + st;
                            db.execute("update centertbl set Covaxin='" + newst + "' where name='" + dist + "'");
                            db.execute("update adddist_tbl set Covaxin ='" + rem + "' where dname='" + dname + "'");
                        }

                    }
                }
            } catch (SQLException ex) {
                Logger.getLogger(CenterSupply.class.getName()).log(Level.SEVERE, null, ex);
            } catch (Exception ex) {
                Logger.getLogger(CenterSupply.class.getName()).log(Level.SEVERE, null, ex);
            }
                ...
                if (rs.next()) {
                    ...
                    if (st > cv) {
                        ...
                        if (rs2.next()) {
                            int cov = rs.getInt(6);
                            int rem = cov - st;
                            int oldst = rs2.getInt(10);
                            int newst = oldst + st;
                            db.execute("update centertbl set Covishield='" + newst + "' where name='" + dist + "'");
                            db.execute("update adddist_tbl set Covishield ='" + rem + "' where dname='" + dname + "'");
                            //db.execute("update centertbl set Covishield ='" + rem + "' where vaccine_name='Covishield'");
...
//                        db.execute("update statestock_tbl set stock ='" + rem + "' where vaccine_name='Covaxin'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CenterSupply.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
